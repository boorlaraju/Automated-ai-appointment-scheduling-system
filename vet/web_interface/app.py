...
Opens in browser for easy access and management
"""
...
sys.path.append(os.path.join(os.path.dirname(__file__), '..', 'scheduling'))
...
scheduler = None
data_path = os.path.join(os.path.dirname(__file__), '..', 'scheduling', 'data')
